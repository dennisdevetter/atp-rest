...
describe('importer match controller', () => {
    
    var sut_saveMatch = controller.save
    ...
    it ('should not save when the match is already found', () => {
      ...
      var matchWasFound = new Promise((resolve, reject) => resolve(matchModel))          
    ...
    it ('should save when the match is not found', (done) => {
      ...
      var matchWasNotFound = new Promise((resolve, reject) => resolve(null))          
      var findMatch = root.sandbox.stub(MatchModel, 'findOne').returns(matchWasNotFound)        
      var matchModel = { save : () => new Promise((resolve, reject) => resolve()) }
